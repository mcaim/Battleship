...
class HumanPlayer:
    ...
    def __init__(self, player_name):
        ...
        self.misses = 0
    def stats(self):
        print("You have attacked ",self.attacks," times, with ", self.hits, " hits and ",self.misses,  " misses.")
...
# The ComputerPlayer class represents a player controlled by user input.
class ComputerPlayer:
    ...
    def take_turn(self):
        ...
        hit_flag = self.opponent.board.attack(x, y)
        if hit_flag:
            print("The computer attacked (",x,',',y,") and hit.",sep='')
            print()
        else:
            print("The computer attacked (",x,',',y,") and missed.",sep='')
            print()
